...
int main(){
  ...
  *total_collisions = 0;
  ...
  Drone.ClearOutput_1File(distance_from_airport, Airport);
  int i;
  ...
  for(i=0; i < Aircraft.Aircraft_Index_size-1; ++i){
    ...
    Drone.ClearOutput(i, distance_from_airport, Airport);
  ...
  Drone.Output_1File_Collision_Num(total_collisions, distance_from_airport, Airport);
