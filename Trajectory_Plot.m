...
drone_data = importdata("Drone_Collisions_" + distance_from_airport + "_km/Depart/Drone_coords_1.csv");
drone_position = importdata("drone_inital_positions_1.0km.csv");
...
for i = 1:length(drone_data(:,1))
    if drone_data(i,5) == 1
        collision_index(end+1) = i;
    end
end

collision_index = collision_index(2:end);
